    ...
    <section className="flex h-fit w-full flex-col items-start justify-start px-20 py-16">
      ...
      <div className="mx-auto flex h-fit w-9/12 flex-row items-start justify-between gap-10 rounded-xl border border-[#5C5667] bg-[#343238] p-6 mb-6">
        <div className="flex h-fit w-1/5 flex-col items-center justify-start">
          <h5 className="montrealBold mb-2 text-8xl text-whiteText-500">Q1</h5>
      ...
      <div className="mx-auto flex h-fit w-9/12 flex-row items-start justify-between gap-10 rounded-xl border border-[#5C5667] bg-[#343238] p-6 mb-6">
        <div className="flex h-fit w-1/5 flex-col items-center justify-start">
          <h5 className="montrealBold mb-2 text-8xl text-whiteText-500">Q2</h5>
          <p className=" montrealMedium text-xl text-whiteText-500">
            Apr To Jun
          </p>
        </div>
      ...
      <div className="mx-auto flex h-fit w-9/12 flex-row items-start justify-between gap-10 rounded-xl border border-[#5C5667] bg-[#343238] p-6 mb-6">
        <div className="flex h-fit w-1/5 flex-col items-center justify-start">
          <h5 className="montrealBold mb-2 text-8xl text-whiteText-500">Q3</h5>
          <p className=" montrealMedium text-xl text-whiteText-500">
            Jun To Sep
          </p>
        </div>
      ...
      <div className="mx-auto flex h-fit w-9/12 flex-row items-start justify-between gap-10 rounded-xl border border-[#5C5667] bg-[#343238] p-6 mb-6">
        <div className="flex h-fit w-1/5 flex-col items-center justify-start">
          <h5 className="montrealBold mb-2 text-8xl text-whiteText-500">Q4</h5>
          <p className=" montrealMedium text-xl text-whiteText-500">
            Oct To Dec
          </p>
        </div>
